...
HD_PWD='C:/Users/deniz/Desktop/Bilkent/CS 223-224/Cs223_Labs/Lab3/Lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux8to1_function.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux8to1_function.tcl
