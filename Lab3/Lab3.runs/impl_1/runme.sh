...
HD_PWD='C:/Users/deniz/Desktop/Bilkent/CS 223-224/Cs223_Labs/Lab3/Lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux8to1_function.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux8to1_function.tcl -notrace
