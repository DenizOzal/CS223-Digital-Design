...
HD_PWD='C:/Users/deniz/Desktop/Bilkent/CS 223-224/Lab2/Lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TwoBitAdderStructural.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TwoBitAdderStructural.tcl -notrace
